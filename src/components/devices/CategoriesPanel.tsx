...
export default function CategoriesPanel({
  ...
  return (
    <>
      <div className="w-full rounded-[24px] border border-gray-200 bg-white p-4 shadow-sm sm:p-5">
        {/* Header */}
          ...
          {categories.length === 0 ? (
            ...
            categories.map((category) => (
              <div
                ...
                className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-gray-50 p-4 transition hover:border-gray-300 hover:bg-white"
              >
                <div className="pr-10">
                ...
                <button
                  ...
                  className="absolute right-3 top-3 inline-flex h-9 w-9 items-center justify-center rounded-xl border border-transparent bg-white text-gray-400 opacity-100 shadow-sm ring-1 ring-gray-100 transition hover:border-red-100 hover:bg-red-50 hover:text-red-600 sm:opacity-0 sm:group-hover:opacity-100"
